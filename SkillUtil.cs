    ...
    public static class SkillUtil {
        ...
        public static SkillFamily FindSkillFamilyFromBody(string bodyName, int slotIndex) {
            ...
            if(targetBodyIndex == BodyIndex.None) {
                AdmiralPlugin._logger.LogError($"FindSkillFamilyFromBody: Couldn't find body with name {bodyName}");
                return null;
            }
            var allSlots = BodyCatalog.GetBodyPrefabSkillSlots(targetBodyIndex);
            if(slotIndex < 0 || slotIndex > allSlots.Length) {
                AdmiralPlugin._logger.LogError($"FindSkillFamilyFromBody: Skill slot index {slotIndex} is invalid for body with name {bodyName}");
                return null;
            }
        ...
        public static SkillFamily FindSkillFamilyFromBody(string bodyName, SkillSlot slot) {
            ...
            if(!skLoc) {
                AdmiralPlugin._logger.LogError($"FindSkillFamilyFromBody: Body with name {bodyName} has no SkillLocator");
                return null;
            }
            ...
            AdmiralPlugin._logger.LogError($"FindSkillFamilyFromBody: Body with name {bodyName} has no skill in slot {slot}");
            return null;
        }
        ...
        public static void ReplaceVariant(this SkillFamily targetFamily, SkillDef origDef, SkillDef newDef) {
            ...
            if(ind < 0) {
                AdmiralPlugin._logger.LogError($"SkillFamily.OverrideVariant: couldn't find target skilldef {origDef} in family {targetFamily}");
                return;
            }
        ...
        public static void ReplaceVariant(string targetBodyName, int targetSlot, SkillDef origDef, SkillDef newDef) {
            ...
            if(targetFamily != null)
                ...
                AdmiralPlugin._logger.LogError("Failed to OverrideVariant for bodyname+slot (target not found)");
        }
        ...
        public static void ReplaceVariant(string targetBodyName, SkillSlot targetSlot, SkillDef origDef, SkillDef newDef) {
            ...
            if(targetFamily != null)
                ...
                AdmiralPlugin._logger.LogError("Failed to OverrideVariant for bodyname+slotname (target not found)");
        }
        ...
        public static void AddVariant(string targetBodyName, int targetSlot, SkillDef newDef, UnlockableDef unlockableDef = null) {
            ...
            if(targetFamily != null)
                ...
                AdmiralPlugin._logger.LogError("Failed to AddVariant for bodyname+slot (target not found)");
        }
        ...
        public static void AddVariant(string targetBodyName, SkillSlot targetSlot, SkillDef newDef, UnlockableDef unlockableDef = null) {
            ...
            if(targetFamily != null)
                ...
                AdmiralPlugin._logger.LogError("Failed to AddVariant for bodyname+slotname (target not found)");
        }
        ...
        public static void RemoveVariant(this SkillFamily targetFamily, SkillDef targetDef) {
            ...
            if(trimmedVariants.Count - oldLen == 0) AdmiralPlugin._logger.LogError($"SkillFamily.RemoveVariant: Couldn't find SkillDef {targetDef} for removal from SkillFamily {targetFamily}");
        ...
        public static void RemoveVariant(string targetBodyName, int targetSlot, SkillDef targetDef) {
            ...
            if(targetFamily != null)
                ...
                AdmiralPlugin._logger.LogError("Failed to RemoveVariant for bodyname+slot (target not found)");
        }
        ...
        public static void RemoveVariant(string targetBodyName, SkillSlot targetSlot, SkillDef targetDef) {
            ...
            if(targetFamily != null)
                ...
                AdmiralPlugin._logger.LogError("Failed to RemoveVariant for bodyname+slotname (target not found)");
        }
